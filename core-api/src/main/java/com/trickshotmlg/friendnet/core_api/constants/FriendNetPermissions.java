...
public class FriendNetPermissions {
    ...
    public static final String FRIEND_ACCEPT = PERMISSION_PREFIX + ".friends.requests.accept";
    public static final String FRIEND_CANCEL = PERMISSION_PREFIX + ".friends.requests.cancel";
    public static final String FRIEND_DENY = PERMISSION_PREFIX + ".friends.requests.deny";
